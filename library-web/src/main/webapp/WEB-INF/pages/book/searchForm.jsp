...
<div id="searchForm">
	...
	<h3><spring:message code="book.search.title" /></h3>
	...
	<form:form action="${searchBooskUrl}" commandName="searchForm" method="POST"
		...
		<div class="formCriterias">
			<div class="col-sm-12 form-group">
				<form:label path="title"><spring:message code="book.search.form.label.title" /></form:label> 
				<form:input	cssClass="form-control" path="title" id="titleId" />
			</div>
			<div class="col-sm-6 form-group">
				<form:label path="authorName"><spring:message code="book.search.form.label.authorName" /></form:label>
				<form:input cssClass="form-control" path="authorName" id="authorNameId" />
			</div>
			<div class="col-sm-6 form-group">
				<form:label path="authorSurname"><spring:message code="book.search.form.label.authorSurname" /></form:label>
				<form:input cssClass="form-control" path="authorSurname" id="authorSurnameId" />
			</div>
			<div class="col-sm-6 form-group">
				<form:label path="category"><spring:message code="book.search.form.label.category" /></form:label>
				<form:input cssClass="form-control" path="category" id="categoryId" />
			</div>
			<div class="col-sm-6 form-group">
				<form:label path="location"><spring:message code="book.search.form.label.location" /></form:label>
		...
		<div class="formActions">
			...
			<form:button class="btn btn-primary search"><span class="glyphicon glyphicon-search"></span> <spring:message code="button.search"/></form:button>
		</div>
	</form:form>
</div>
...
<div class="searchResults">
	...
	<table class="table table-condensed">
		<thead>
			<tr>
				<th><spring:message code="book.search.result.table.header.title" /></th>
				<th><spring:message code="book.search.result.table.header.author" /></th>
				<th><spring:message code="book.search.result.table.header.category" /></th>
				<th><spring:message code="book.search.result.table.header.location" /></th>
				<th><spring:message code="book.search.result.table.header.actions" /></th>
			<tr>
		</thead>
		<tbody>
			...
			<c:choose>
				...
				<c:otherwise>
					<tr>
						<td colspan="6"><spring:message code="results.table.noResults" /></td>
					</tr>
				</c:otherwise>
			</c:choose>
		</tbody>
	...
	<c:if test="${!empty searchResult && !empty searchResult.result }">
		...
		<jsp:include page="/tags/paginationFooter.jsp">
			<jsp:param name="initial" value ="searchResult.initial"/>
			<jsp:param name="pageSize" value="searchResult.pageSize"/>
			<jsp:param name="total" value="searchResult.total"/>
		</jsp:include>

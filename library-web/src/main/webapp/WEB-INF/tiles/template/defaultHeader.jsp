	...
	<ul class="nav navbar-nav navbar-right collapse navbar-collapse">
		...
		<li class="dropdown">
			<a href="#" data-target="#" class="dropdown-toggle" data-toggle="dropdown">
				<spring:message code="menu.item.book" /> <span class="caret"></span>
			</a>
			<ul class="dropdown-menu">
				<c:url var="searchBookUrl" value="${searchBookAction }" />
				<li>
					<a href="${searchBookUrl }">
						<spring:message code="menu.item.book.search" />
					</a>
				</li>
				<li>
					<c:url var="createBookUrl" value="${createFormAction }" />
					<a href="${createBookUrl }"> 
						<spring:message code="menu.item.book.create" />
					</a>
				</li>
			</ul>
		</li>
		...
		<li class="dropdown">
			<a href="#" data-target="#" class="dropdown-toggle" data-toggle="dropdown">
				<spring:message code="menu.item.author" /> <span class="caret"></span>
			</a>
			<ul class="dropdown-menu">
				<li>
					<c:url var="searchAuthorsUrl" value="${searchAuthor }" />
					<a href="${searchAuthorsUrl }">
						<spring:message code="menu.item.author.search" />
					</a>
				</li>
				<li>
					<c:url var="createAuthorUrl" value="${createAuthorFormAction }" />
					<a href="${createAuthorUrl }">
						<spring:message code="menu.item.author.create" />
					</a>
				</li>
			</ul>
		</li>
